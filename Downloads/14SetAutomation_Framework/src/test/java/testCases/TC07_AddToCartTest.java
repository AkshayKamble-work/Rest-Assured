...
public class TC07_AddToCartTest extends BaseClass {
    ...
    public void testCartItemDetails() throws InterruptedException {
        ...
        try {
            ...
            logger.info("Navigating to Home Page and searching for 'Macbook'");
            HomePage homePage = new HomePage(driver);
           homePage.searchProduct("Macbook");
           
            logger.info("'Macbook' search initiated");
            ...
            logger.info("'Macbook' added to the cart successfully");
            ...
            //Assert.assertTrue(cartDetails.contains("Macbook"), "Cart does not contain the expected product!");
            
            logger.info("Verification successful: 'Macbook' is present in the cart");
