...
public class Student {
	...
	//Once we create an object compulsory we required to perform initialization fit that object
	//if your not performing initialization then object is not responding correct output
